...
class RssSensor(object):
    ...
    def __init__(self, parent_actor, world, unstructured_scene_visualizer, bounding_box_visualizer, state_visualizer,
                ...
                if actor_speed < 0.01:
                    ...
                    if actor_constellation_result.rss_calculation_mode == ad.rss.map.RssMode.Structured:
                        ...
                        actor_distance = math.sqrt(
                            float(actor_constellation_data.ego_match_object.enuPosition.centerPoint.x -
                        ...
                        if actor_constellation_data.ego_dynamics_on_route.ego_speed < 0.01:
                            ...
                            if actor_distance < 10:
                                ...
                                if other_outside_routeable_road:
                                    ...
                                    # behind a red light...)
                                    heading_delta = abs(
                                        float(actor_constellation_data.ego_match_object.enuPosition.heading -
                            ...
                            if actor_distance < 10:
                                ...
                                try:
                                    if self.change_to_unstructured_position_map[
                                        actor_id] == actor_constellation_data.other_match_object.enuPosition:
                                        heading_delta = abs(
                                            float(actor_constellation_data.ego_match_object.enuPosition.heading -
                                                  actor_constellation_data.other_match_object.enuPosition.heading))
    ...
    def get_steering_ranges(self):
        ...
        for heading_range in self._allowed_heading_ranges:
            ranges.append(
                (
                    (float(self.ego_dynamics_on_route.ego_heading) - float(
                        heading_range.begin)) / self._max_steer_angle,
